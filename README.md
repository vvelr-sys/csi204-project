...
- [โครงสร้างโปรเจกต์ (ตัวอย่าง)](#-โครงสร้างโปรเจกต์-ตัวอย่าง)
...
| 3 | Development | พัฒนา Frontend (Next.js) และ Backend (Node.js) พร้อมจำลอง Database (LocalStorage) |
| 4 | Testing & Deployment | ทดสอบระบบ (UAT), เผยแพร่ผ่าน GitHub Pages และนำเสนอผลงาน |
...
| Frontend | Next.js |
| Backend | Node.js |
| Database | Local Storage (สำหรับสาธิตต้นแบบ) |
